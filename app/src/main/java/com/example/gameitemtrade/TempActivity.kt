...
class TempActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aaaa = findViewById(R.id.aaa) as ImageView

        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this)
        getLastLocation()

        Picasso.get().load("http://192.168.55.69:65001/imgs/origianl_photo.jpg").error(R.drawable.nonephoto).into(aaaa)
    }
            ...
            if (isLocationEnabled()) {
                ...
                mFusedLocationClient.lastLocation.addOnCompleteListener(this) { task ->
                    ...
                    if (location == null) {
                        ...
                        val latTextView = findViewById(R.id.latTextView) as TextView
                        val lonTextView = findViewById(R.id.lonTextView) as TextView
